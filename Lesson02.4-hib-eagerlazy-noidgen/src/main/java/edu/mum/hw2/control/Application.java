...
public class Application {
	...
	private static void addMovies() {
		...
		try {
			...
			System.out.println("Movie 1[id](before persist NO GEN ID): "+movie1.getId());
			session.persist(movie1);
			System.out.println("Movie 1[id](after persist NO GEN ID): "+movie1.getId());
			...
			System.out.println("Movie 2[id](before persist NO GEN ID): "+movie2.getId());
			session.persist(movie2);
			System.out.println("Movie 2[id](after persist NO GEN ID): "+movie2.getId());
			...
			System.out.println("Movie B1[id](before save NO GEN ID): "+movieB1.getId());
			session.save(movieB1);
			System.out.println("Movie B1[id](after save NO GEN ID): "+movieB1.getId());
			...
			System.out.println("Movie 2B[id](before save NO GEN ID): "+movieB2.getId());
			session.save(movieB2);
			System.out.println("Movie 2B[id](after save NO GEN ID): "+movieB2.getId());
